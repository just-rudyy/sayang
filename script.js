...
const handleYesClick = () => {
  question.innerHTML = "Yeahhhhhhhhhhh! CALL ME THENNN!!!!!!";
  gif.src = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNGs5ZnJvdGJ1eHBwaHRuc2N0MXp5djF0dTEzN2ltYXNkZ2E3czB4cCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/2Tx2smt0cqbCUhmKBQ/giphy-downsized-large.gif";
  ...
  letsGoBtn.addEventListener("click", () => {
    ...
    alert(`We can do this in sleep vc : ${selectedDateIdea}`);
  });
